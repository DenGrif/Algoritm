# Например, 2 — это простое число, так как делится на 1 и на 2.
# Следующее простое число — 3, которое делится на 1 и на 3.
# Еще одно простое число — 5, делящееся на 1 и на 5.
#
# Числа, не являющиеся простыми, имеют больше двух делителей.
# Например, 4 (делится на 1, на 2 и на 4) — это непростое число;
# 6 (делится на 1, на 2, на 3 и на 6) — это непростое число.
